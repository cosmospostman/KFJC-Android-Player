...
public abstract class MediaStateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        MediaSource source = intent.getParcelableExtra(PlayerState.INTENT_KEY_PLAYER_SOURCE);
    ...
    protected abstract void onStateChange(PlayerState.State state, MediaSource source);
